                ...
                <form className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="firstName" defaultValue="SaaS" className="mt-1 block w-full bg-gray-700 border-gray-600 rounded-md shadow-sm text-white focus:ring-primary focus:border-primary" />
                        </div>
                        <div>
                            <label htmlFor="lastName" className="block text-sm font-medium text-gray-400">Sobrenome</label>
                            <input type="text" id="lastName" defaultValue="Admin" className="mt-1 block w-full bg-gray-700 border-gray-600 rounded-md shadow-sm text-white focus:ring-primary focus:border-primary" />
                        </div>
                    </div>
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium text-gray-400">Endereço de E-mail</label>
                        <input type="email" id="email" defaultValue="admin@saascorp.io" className="mt-1 block w-full bg-gray-700 border-gray-600 rounded-md shadow-sm text-white focus:ring-primary focus:border-primary" />
                    </div>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="mt-1 flex rounded-md shadow-sm">
                            <input type="text" id="apiKey" readOnly value="************************" className="flex-1 block w-full min-w-0 rounded-none rounded-l-md bg-gray-700 border-gray-600 text-white focus:ring-primary focus:border-primary" />
